...
void PendingSoapCallShould::map_Soap_Error_Codes_To_Enum_When_Call_Finished_data()
{
    ...
    QSharedPointer<SoapCallDouble> soapCallDoubleNoError{new SoapCallDouble()};
    soapCallDoubleNoError->setErrorState(false);

    QTest::newRow("Error code should be NoError") << soapCallDoubleNoError << PendingSoapCall::ErrorCode::NoError;
    ...
    QTest::newRow("Should be InvalidAction")
        << soapCallDoubleInvalidAction << PendingSoapCall::ErrorCode::InvalidAction;
    ...
    QTest::newRow("Should be InvalidArgs") << soapCallDoubleInvalidArgs << PendingSoapCall::ErrorCode::InvalidArgs;
    ...
    QTest::newRow("Should be ActionFailed") << soapCallDoubleActionFailed << PendingSoapCall::ErrorCode::ActionFailed;
    ...
    QTest::newRow("Should be Argument value invalid")
        << soapCallDoubleArgumentValueInvalid << PendingSoapCall::ErrorCode::ArgumentValueInvalid;

    qint32 argumentValueOutOfRangeInvaliddErrorCode = 601;
    QString argumentValueOutOfRangeInvaliddErroCodeXML =
        QString{errorXML}.arg(argumentValueOutOfRangeInvaliddErrorCode);
    ...
    QTest::newRow("Should be Argument value out of range")
        << soapCallDoubleArgumentValueOutOfrange << PendingSoapCall::ErrorCode::ArgumentValueOutOfRange;
    ...
    QTest::newRow("Should be optional action not implemented.")
        << soapCallDoubleOptionalActionNotImplemented << PendingSoapCall::ErrorCode::OptionalActionNotImplemented;
    ...
    QTest::newRow("Should be out of memory") << soapCallDoubleOutOfMemory << PendingSoapCall::ErrorCode::OutOfMemory;
    ...
    QTest::newRow("Should be human intervention required")
        << soapCallDoubleHumanInterventionRequired << PendingSoapCall::ErrorCode::HumanInterventionRequired;
    ...
    QTest::newRow("Should be string argument to long")
        << soapCallDoubleStringArgumentTooLong << PendingSoapCall::ErrorCode::StringArgumentTooLong;
    ...
    QTest::newRow("Should be action not authorized")
        << soapCallDoubleActionNotAuthorized << PendingSoapCall::ErrorCode::ActionNotAuthorized;
    ...
    QTest::newRow("Should be signature failure")
        << soapCallDoubleSignatureFailure << PendingSoapCall::ErrorCode::SignatureFailure;
    ...
    QTest::newRow("Should be signature missing")
        << soapCallDoubleSignatureMissing << PendingSoapCall::ErrorCode::SignatureMissing;
    ...
    QTest::newRow("Should be not encrypted") << soapCallDoubleNotEncrypted << PendingSoapCall::ErrorCode::NotEncrypted;
    ...
    QTest::newRow("Should be invalid sequence")
        << soapCallDoubleInvalidSequence << PendingSoapCall::ErrorCode::InvalidSequence;
    ...
    QTest::newRow("Should be invalid control url")
        << soapCallDoubleInvalidControlUrl << PendingSoapCall::ErrorCode::InvalidControlUrl;
    ...
    QTest::newRow("Should be nu such session")
        << soapCallDoubleNoSuchSession << PendingSoapCall::ErrorCode::NoSuchSession;
}
...
void PendingSoapCallShould::
    return_An_Object_That_is_Constructable_With_QString_That_Returns_The_Message_When_Call_Finished()
{
    QSharedPointer<SoapCallDouble> soapCallDouble{new SoapCallDouble{}};
